import {CURVE_USDe_USDC_GAUGE} from "../erc20/curve";
...
import {CRV_DUO_USDC_crvUSD, CRV_DUO_USDe_USDC, CRV_DUO_USDT_crvUSD, CRV_GAUGE_USDC_crvUSD, CRV_GAUGE_USDT_crvUSD} from "../lps/curve";
...
export const CURVE_CONTEXT = {
    ...
    USDe_USDC: {
        curveLp: CRV_DUO_USDe_USDC,
        curveGauge: CURVE_USDe_USDC_GAUGE,
    },
};
