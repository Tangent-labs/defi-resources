...
export const PENDLE_POOLS: {
    ...
    "USR 09/04/25": {
        ...
        UNDERLYING_IN: [COMMON_ERC20S.USR],
        UNDERLYING_OUT: [COMMON_ERC20S.USR],
    },
    "sUSDe 27/11/25": {
    ...
    "sUSDf 29/01/26": {
        ...
        UNDERLYING_IN: [COMMON_ERC20S.USDf, COMMON_ERC20S.sUSDf],
        UNDERLYING_OUT: [COMMON_ERC20S.USDf, COMMON_ERC20S.sUSDf],
    },
    "USDe 27/11/25": {
    ...
    "reUSD 25/06/26": {
        ...
        UNDERLYING_IN: [COMMON_ERC20S.reUSD],
        UNDERLYING_OUT: [COMMON_ERC20S.reUSD],
    },
    "wstUSR 29/01/26": {
