...
export const THIEF_TOKEN_CONFIG: {
    ...
    fxUSD_reUSD: {
        isVyper: true,
        slotBalance: 38,
        address: CURVE_LPS.DUO_fxUSD_reUSD,
        decimals: 18,
    },
    frxUSD_sUSDS: {
        isVyper: true,
        slotBalance: 38,
        address: CURVE_LPS.DUO_frxUSD_sUSDS,
        decimals: 18,
    },
    BOLD_USDC: {
        isVyper: true,
        slotBalance: 38,
        address: CURVE_LPS.DUO_BOLD_USDC,
        decimals: 18,
    },
    eUSD_USDC: {
        isVyper: true,
    ...
    frxUSD_OUSD: {
        isVyper: true,
        slotBalance: 38,
        address: CURVE_LPS.DUO_frxUSD_OUSD,
        decimals: 18,
    },
    frxUSD_sDOLA: {
        isVyper: true,
        slotBalance: 38,
        address: CURVE_LPS.DUO_frxUSD_sDOLA,
        decimals: 18,
    },
    frxUSD_scrvUSD: {
        isVyper: true,
        slotBalance: 38,
        address: CURVE_LPS.DUO_frxUSD_scrvUSD,
        decimals: 18,
    },
    tBTC: {
        isVyper: false,
