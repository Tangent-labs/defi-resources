import { CVG, DAI, FRAX, WETH, CRV, CVX, CNC, FXS, PENDLE, SDT, USDC, USDT, crvUSD, wstETH, FIS, LDO, SPELL, BAL, ANGLE, FXN, eUSD, PRISMA, FPIS, YFI, APW } from "./common";
import { CRV_DUO_FRAXBP, CRV_TRI_CRYPTO_USDC, CRV_DUO_USDT_crvUSD, CRV_DUO_STG_USDC, CRV_TRI_CRYPTO_LLAMA, CRV_DUO_SDCRV_CRV, CRV_DUO_USDC_crvUSD, CRV_DUO_frxETH_ETH, CRV_TRI_CRYPTO_USDT, CRV_DUO_cvxCRV_CRV, CRV_DUO_SDFXS_FXS, CRV_DUO_agEUR_EUROC, CRV_DUO_MIM_3CRV, CRV_DUO_dETH_frxETH, CRV_DUO_alUSD_FRAXBP, CRV_TRI_CRYPTO_USDT2, CRV_DUO_ETH_rETH, CRV_DUO_XAI_crvUSD, CRV_DUO_COIL_FRAXBP, CRV_DUO_sUSD_CRVUSD, CRV_DUO_DOLA_crvUSD, CRV_DUO_mkUSD_FRAXBP, LP_CRV_DUO_ETH_CNC, CRV_DUO_XAI_FRAXBP, CRV_TRI_CRYPTO_SDT, CRV_TRI_CRYPTO_CRV, CRV_DUO_stETH_ETH, CRV_DUO_crvUSD_FRAX, CRV_DUO_ETHp_WETH, CRV_DUO_WETH_SDT, CRV_DUO_pxETH_stETH, CRV_DUO_pxETH_frxETH, CRV_DUO_PYUSD_USDC, CRV_DUO_CVG_ETH, CRV_DUO_cvgSDT_SDT, CRV_DUO_eUSD_FRAXBP, _3CRV } from "../lps/curve";
import { SD_FRAX_3CRV, sdCRV, sdCRV_GAUGE, sdPENDLE, sdFXS, sdBAL, BB_A_USD, sdANGLE, SAN_USDC_EUR, AG_EUR, sdFXN, sdYFI, sdAPW, _80BAL_20WETH } from "./stakeDao";
